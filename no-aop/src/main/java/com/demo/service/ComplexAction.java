...
public class ComplexAction {
    ...
    public void takeAction(){
        ...
        PerformanceLogger.PerformanceInfo performanceInfo = logger
                .begin("ReportFormatter::formatReport(new Report())");
        Report formattedReport = reportFormatter.formatReport(new Report()); //primary concern
        ...
        performanceInfo = logger
                .begin("ReportProvider::reportProvider.reportProvider()");
